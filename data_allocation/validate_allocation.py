...
This validates the *allocation-stage* output (data_for_model_<city>.mat:
...
City-agnostic: main_alloc.m's file/NAME convention keys everything off a
city folder name (JER, BS08, Arad, ASH22, ...) sitting alongside
data_allocation/, each with its own sa_data_b7.csv. Pass --city to pick
one, or override --mat/--census/--out individually.

Usage
-----
    python validate_allocation.py --city JER
    python validate_allocation.py --city BS08
    python validate_allocation.py --mat data_for_model_JER.mat --census ..\\JER\\sa_data_b7.csv
"""
...
def main():
    ...
    ap.add_argument('--out', default=None,
                     help='defaults to data_allocation/allocation_validation_report_<city>.csv')
    args = ap.parse_args()
    ...
    out_path = args.out or os.path.join(here, f'allocation_validation_report_{args.city}.csv')
